...
DanceApp::DanceApp() : GraphicsApp(1280,768, "So You Think Ants Can Dance") {
    ...
    //======================================================================================================
    //Special Monition 2
    ballet_special2_.LoadFromAMC(Platform::FindFile("05_20.amc", searchPath_), *ballet_ant_.skeleton_ptr());
    ballet_special2_.TrimFront(600);
    ...
    //======================================================================================================
    //Special Monition 5
    ballet_special5_.LoadFromAMC(Platform::FindFile("05_10.amc", searchPath_), *ballet_ant_.skeleton_ptr());
